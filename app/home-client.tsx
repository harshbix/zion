...
import { shimmerDataURL, CREAM_BLUR_PIXEL } from '@/lib/image-utils';
        ...
        <div className="relative z-10 text-center max-w-4xl px-6 flex flex-col items-center">
          ...
          >
            <div className="w-16 h-16 border border-white/20 bg-white/5 backdrop-blur-md rounded-none p-2 flex items-center justify-center">
              <Image src="/logo.png" alt="Zion Logo" width={48} height={48} className="object-contain filter invert" placeholder="blur" blurDataURL={CREAM_BLUR_PIXEL} />
            </div>
          </motion.div>

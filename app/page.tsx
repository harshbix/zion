    ...
    <div className="bg-[#FFFBF5]">
        ...
        <div className="relative z-10 text-center max-w-4xl px-6 flex flex-col items-center">
          ...
          >
            <div className="w-16 h-16 border border-white/20 bg-white/5 backdrop-blur-md rounded-none p-2 flex items-center justify-center">
              <Image src="/logo.png" alt="Zion Logo" width={48} height={48} className="object-contain filter invert" />
            </div>
          </motion.div>
          ...
          <motion.h1
            ...
            className="font-serif-luxury text-white text-5xl md:text-7xl lg:text-8xl font-black mb-6 leading-[1.05]"
          ...
          <motion.p
            ...
            className="text-amber-100 text-lg md:text-2xl font-serif-luxury font-light mb-12 tracking-wide"
          >
          ...
          >
            <Link href="/shop" className="premium-btn-primary bg-amber-600 border border-amber-600 hover:bg-white hover:text-stone-950">
              Shop the Collection
            </Link>
            <Link href="/about" className="inline-flex items-center justify-center border border-white/40 text-white hover:bg-white hover:text-stone-900 transition-colors uppercase font-sans-luxury text-[10px] tracking-widest px-8 py-5">
              Read Our Story
            </Link>
          </motion.div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative aspect-[4/5] overflow-hidden border border-stone-200 p-4 bg-white/50">
              ...
              <div className="absolute bottom-10 left-10 text-white z-10 space-y-1">
                ...
                <p className="font-serif-luxury text-2xl font-bold">Est. Mbeya, Tanzania</p>
              </div>
            ...
            <div className="space-y-12">
              ...
              <div className="pt-4">
                <Link href="/about" className="inline-flex items-center gap-3 font-sans-luxury text-[10px] font-bold uppercase tracking-widest text-stone-900 hover:text-amber-600 group transition-colors">
      ...
      <section className="py-24 bg-white border-y border-stone-200/50">
        <div className="container-premium">
          <div className="mb-16 flex flex-col md:flex-row items-baseline justify-between gap-6">
            ...
            <Link href="/shop" className="inline-flex items-center gap-3 font-sans-luxury text-[10px] font-bold uppercase tracking-widest text-amber-600 hover:text-amber-700 transition-colors">
              ...
              <div key={item.id} className="luxury-card group flex flex-col justify-between p-4 border border-stone-100">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <h3 className="font-serif-luxury text-lg text-stone-900 font-bold mt-1">
        ...
        <div className="container-premium flex flex-col items-center text-center">
          ...
          <div className="max-w-3xl h-44 flex items-center justify-center">
            <motion.p
              ...
              className="font-serif-luxury text-stone-900 text-2xl md:text-3xl leading-relaxed italic"
            >
      ...
      <section className="section-padding-luxury bg-stone-950 text-white relative overflow-hidden">
        ...
        <div className="container-premium relative z-10 text-center max-w-4xl space-y-10">
          ...
          <h2 className="font-serif-luxury text-white text-4xl md:text-6xl font-bold leading-tight">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
            <Link href="/shop" className="inline-flex items-center justify-center bg-white text-stone-950 font-semibold uppercase tracking-[0.25em] text-xs px-10 py-5 hover:bg-amber-500 hover:text-white transition-all duration-500">
              Browse Menu
            </Link>
            <Link href="/contact" className="inline-flex items-center justify-center border border-white/20 text-white font-semibold uppercase tracking-[0.25em] text-xs px-10 py-5 hover:bg-white hover:text-stone-950 transition-all duration-500">
              Custom Commissions
            </Link>
          </div>
        </div>

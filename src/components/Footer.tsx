    ...
    <footer className="border-t border-stone-200 bg-[#FFFBF5] py-16 text-stone-600">
      <div className="container-premium grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div className="space-y-3 flex flex-col">
          ...
          <Link to="/shop" className="text-xs hover:text-amber-600 transition-colors">
            All Products
          </Link>
          <Link to="/categories" className="text-xs hover:text-amber-600 transition-colors">
            Browse Categories
          </Link>
          <Link to="/collections" className="text-xs hover:text-amber-600 transition-colors">
            Curated Collections
          </Link>
        </div>
        ...
        <div className="space-y-3 flex flex-col">
          ...
          <Link to="/faq" className="text-xs hover:text-amber-600 transition-colors">
            FAQs & Inquiries
          </Link>
          <Link to="/contact" className="text-xs hover:text-amber-600 transition-colors">
            Contact & Location
          </Link>
          <Link to="/order-tracking" className="text-xs hover:text-amber-600 transition-colors">
            Track Order
          </Link>
        </div>
        ...
        <div className="space-y-3 flex flex-col">
          ...
          <Link to="/blog" className="text-xs hover:text-amber-600 transition-colors">
            Our Journal (Blog)
          </Link>
          <Link to="/about" className="text-xs hover:text-amber-600 transition-colors">
            Our Heritage Story
          </Link>
      ...
      <div className="container-premium border-t border-stone-200 mt-12 pt-8 flex flex-col md:flex-row items-center justify-between text-xs text-stone-500 font-sans-luxury tracking-wider gap-4">
        ...
        <div className="flex gap-6">
          ...
          <Link to="/admin" className="hover:text-amber-600 transition-colors font-bold text-stone-700">ADMIN</Link>
        </div>
      </div>
    </footer>
  );

          ...
          <AnimatePresence mode="popLayout">
            {filteredPosts.length > 0 ? (
              filteredPosts.map((post) => (
                ...
                >
                  <div>
                    <Link to={`/blog/${post.slug}`} className="block relative aspect-[3/2] overflow-hidden mb-6">
                      <img src={post.image}
                        alt={post.title}
                  ...
                  <div className="pt-6 mt-6 border-t border-stone-100">
                    <Link to={`/blog/${post.slug}`} className="font-sans-luxury text-[9px] font-bold uppercase tracking-widest text-stone-900 hover:text-amber-600 group-hover:underline transition-colors flex items-center gap-2">
